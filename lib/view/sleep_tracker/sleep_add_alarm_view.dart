...
class SleepAddAlarmView extends StatefulWidget {
  ...
  @override
  State<SleepAddAlarmView> createState() => _ASleepAddAlarmViewState();
}

class _ASleepAddAlarmViewState extends State<SleepAddAlarmView> {
  bool positive = false;
  @override
                    ...
                    child: Transform.scale(
                      ...
                      child: CustomAnimatedToggleSwitch<bool>(
                        ...
                        iconBuilder: (context, local, global) {
                          return const SizedBox(); // vẫn giữ như bạn muốn
                        },
