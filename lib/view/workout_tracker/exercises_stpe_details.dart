            ...
            children: [
              ...
              SizedBox(
                ...
                child: CupertinoPicker.builder(
                  itemExtent: 40, // Chiều cao của mỗi item
                  selectionOverlay: Container(
                    width: double.maxFinite, // Chiều rộng phủ toàn picker
                    height:
                        40, // Chiều cao vùng highlight (trùng với itemExtent)
                    decoration: BoxDecoration(
                      border: Border(
                        // Viền trên của vùng highlight
                        top: BorderSide(
                          color: TColor.gray.withOpacity(0.2),
                          width: 1,
                        ),
                        // Viền dưới của vùng highlight
                        bottom: BorderSide(
                          color: TColor.gray.withOpacity(0.2),
                          width: 1,
                        ),
                  ...
                  onSelectedItemChanged: (index) {
                    // Hàm gọi khi người dùng chọn item mới
                  },
                  childCount: 60, // Số lượng item trong picker
                  itemBuilder: (context, index) {
                    // Cách hiển thị từng item
                    return Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Image.asset(
                          "assets/img/burn.png", // Icon ngọn lửa
                          width: 15,
                          height: 15,
                          fit: BoxFit.contain,
                        ),
                        Text(
                          " ${(index + 1) * 15} Calories Burn", // Số calo đốt
